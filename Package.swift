...
var package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/ianpartridge/swift-backtrace", from: "1.3.1"),
    .package(url: "https://github.com/swift-server/async-http-client", from: "1.13.2"),
    .package(url: "https://github.com/vapor/postgres-kit", from: "2.2.0"),
    .package(url: "https://github.com/vapor/postgres-nio", from: "1.18.0"),
