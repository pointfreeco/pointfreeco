...
extension Episode {
  static let ep68_composableStateManagement_reducers = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_564_984_800),
    references: [
      .reduceWithInout,
      .elmHomepage,
      .reduxHomepage,
    ...
    trailerVideo: .init(
      bytesLength: 59_339_942,
      downloadUrl:
        "https://player.vimeo.com/external/351832614.hd.mp4?s=58db5a30394acaedeba4843d76dca1d211fe7040&profile_id=175&download=1",
