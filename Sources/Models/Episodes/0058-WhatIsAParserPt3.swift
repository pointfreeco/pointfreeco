...
extension Episode {
  static let ep58_whatIsAParser_pt3 = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_558_332_000),
    references: [
      .parseDontValidate,
    ...
    trailerVideo: .init(
      bytesLength: 23_586_284,
      downloadUrl:
        "https://player.vimeo.com/external/348472576.hd.mp4?s=e2f45a4c58972c03ffe9b5dde361426105d0d773&profile_id=175&download=1",
