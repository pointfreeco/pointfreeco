...
extension Episode {
  public static let ep204_reducerProtocol = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1662958800),
    references: [
      ...
      .init(
        ...
        blurb: #"""
          ...
          """#,
        link: "https://forums.swift.org/t/function-builder-cannot-infer-generic-parameters-even-though-direct-call-to-buildblock-can/35886/5",
        publishedAt: referenceDateFormatter.date(from: "2020-04-26"),
        title: "Function builder cannot infer generic parameters even though direct call to `buildBlock` can"
      ),
    ],
    sequence: 204,
