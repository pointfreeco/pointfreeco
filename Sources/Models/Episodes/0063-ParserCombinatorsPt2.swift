...
extension Episode {
  static let ep63_parserCombinators_pt2 = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_561_960_800),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 38_047_077,
      downloadUrl:
        "https://player.vimeo.com/external/349951714.hd.mp4?s=36959b38a26352c1e8599c061b98d10d679ca044&profile_id=175&download=1",
