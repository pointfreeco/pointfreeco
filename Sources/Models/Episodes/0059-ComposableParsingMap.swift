...
extension Episode {
  static let ep59_composableParsing_map = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_558_936_800),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 54_937_265,
      downloadUrl:
        "https://player.vimeo.com/external/349952515.hd.mp4?s=18f323dc2d8a15ae347893efc991c55108c27e2d&profile_id=175&download=1",
