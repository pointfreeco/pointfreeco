...
extension Episode {
  static let ep13_theManyFacesOfMap = Episode(
    ...
    permission: .freeDuring(
      Date(timeIntervalSince1970: 1_524_477_423)..<Date(timeIntervalSince1970: 1_559_541_600)),
    publishedAt: Date(timeIntervalSince1970: 1_524_477_423),
    references: [.theoremsForFree],
    sequence: 13,
    title: "The Many Faces of Map",
    trailerVideo: .init(
      bytesLength: 57_789_611,
      downloadUrl:
        "https://player.vimeo.com/external/354214965.hd.mp4?s=9e2cb40eadea330d69402a6e9844293fb6a4e47f&profile_id=175&download=1",
      streamingSource: "https://player.vimeo.com/video/354214965"
    )
  )
}
