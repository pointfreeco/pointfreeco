...
extension Episode {
  static let ep64_parserCombinators_pt3 = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_562_565_600),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 15_830_908,
      downloadUrl:
        "https://player.vimeo.com/external/348470834.hd.mp4?s=185ff244ef456500852a219970c1a82c73df09d2&profile_id=175&download=1",
