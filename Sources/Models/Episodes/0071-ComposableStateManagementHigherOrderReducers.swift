...
extension Episode {
  static let ep71_composableStateManagement_higherOrderReducers = Episode(
    ...
    trailerVideo: .init(
      ...
      downloadUrl:
        "https://player.vimeo.com/external/355452269.hd.mp4?s=56afb7b0c522691a881fd757ead9eff17c34ac49&profile_id=175&download=1",
      streamingSource: "https://player.vimeo.com/video/355452269"
    )
  )
}
