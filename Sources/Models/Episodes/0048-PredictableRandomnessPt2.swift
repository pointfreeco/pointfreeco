...
extension Episode {
  static let ep48_predictableRandomness_pt2 = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_551_078_000),
    references: [
      .randomUnification,
    ...
    trailerVideo: .init(
      bytesLength: 43_611_137,
      downloadUrl:
        "https://player.vimeo.com/external/348484907.hd.mp4?s=f3bd0056d3cbb264d365523fb4f0621455445b57&profile_id=175&download=1",
      streamingSource: "https://player.vimeo.com/video/348484907"
    )
  )
}
