...
extension Episode {
  static let ep92_modularDependencyInjection_pt2 = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_582_524_000),
    references: [
      reference(
    ...
    trailerVideo: .init(
      ...
      downloadUrl:
        "https://player.vimeo.com/external/393344940.hd.mp4?s=d2527e30f8a8d2e49c3186afbda972a7a075c86b&profile_id=175&download=1",
