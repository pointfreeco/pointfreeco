...
extension Episode {
  static let ep41_aTourOfSnapshotTesting = Episode(
    ...
    fullVideo: .init(
      ...
      downloadUrl:
        "https://player.vimeo.com/external/349952472.hd.mp4?s=22357478e55b228d9ea0a50c1719e71fae7cb29e&profile_id=175&download=1",
    ...
    trailerVideo: .init(
      ...
      downloadUrl:
        "https://player.vimeo.com/external/349952474.hd.mp4?s=7e0f0940da37c67093fcc57c336957d8640b4ee3&profile_id=175&download=1",
...
private let _transcriptBlocks: [Episode.TranscriptBlock] = [
  ...
  Episode.TranscriptBlock(
    ...
    type: .image(
      src:
        "https://d1hf1soyumxcgv.cloudfront.net/0041-tour-of-snapshot-testing/assets/testSnapshot.2.png",
      sizing: .inset)
  ),
  Episode.TranscriptBlock(
    content: """
  ...
  Episode.TranscriptBlock(
    ...
    type: .image(
      src:
        "https://d1hf1soyumxcgv.cloudfront.net/0041-tour-of-snapshot-testing/assets/testLowercase.1.png",
      sizing: .inset)
  ),
  Episode.TranscriptBlock(
    content: """
