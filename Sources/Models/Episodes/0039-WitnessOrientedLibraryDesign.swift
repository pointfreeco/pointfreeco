...
extension Episode {
  static let ep39_witnessOrientedLibraryDesign = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_543_208_400),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 102_105_644,
      downloadUrl:
        "https://player.vimeo.com/external/349952469.hd.mp4?s=9886af414316acc1f0b3fc67cfaf26f6e7b6a4af&profile_id=175&download=1",
