...
extension Episode {
  static let ep47_predictableRandomness_pt1 = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_550_473_200),
    references: [
      .randomUnification,
      reference(
    ...
    trailerVideo: .init(
      bytesLength: 46_323_465,
      downloadUrl:
        "https://player.vimeo.com/external/349952487.hd.mp4?s=64c5c41c6d641feb92e4656302439248a9d1df58&profile_id=175&download=1",
