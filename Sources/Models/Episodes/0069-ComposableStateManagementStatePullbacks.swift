...
extension Episode {
  static let ep69_composableStateManagement_statePullbacks = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_565_589_600),
    references: [
    ...
    trailerVideo: .init(
      ...
      downloadUrl:
        "https://player.vimeo.com/external/353049110.hd.mp4?s=01f74c914424d5005780a54fb755092be8473a89&profile_id=175&download=1",
