...
extension Episode {
  static let ep78_effectfulStateManagement_asynchronousEffects = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_572_242_400),
    references: [
    ...
    trailerVideo: .init(
      ...
      downloadUrl:
        "https://player.vimeo.com/external/369002675.hd.mp4?s=d8c4923585f70c6ade66bc2f6fa7422cfccaebbe&profile_id=175&download=1",
