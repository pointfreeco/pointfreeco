...
extension Episode {
  static let ep26_domainSpecificLanguages_pt1 = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_534_744_623),
    sequence: 26,
    title: "Domain‑Specific Languages: Part 1",
    trailerVideo: .init(
      bytesLength: 27_200_230,
      downloadUrl:
        "https://player.vimeo.com/external/348628453.hd.mp4?s=27ba1e0796d802020fe141ab3102fce35052d43a&profile_id=175&download=1",
