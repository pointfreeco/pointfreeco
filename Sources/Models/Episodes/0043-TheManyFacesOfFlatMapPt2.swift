...
extension Episode {
  static let ep43_theManyFacesOfFlatMap_pt2 = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_547_622_000),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 45_323_451,
      downloadUrl:
        "https://player.vimeo.com/external/349952476.hd.mp4?s=8018674a83d15d84a9467faec8fb1091e3813504&profile_id=175&download=1",
