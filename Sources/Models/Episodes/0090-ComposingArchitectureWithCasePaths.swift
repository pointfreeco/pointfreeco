...
extension Episode {
  static let ep90_composingArchitectureWithCasePaths = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_581_314_400),
    references: [
      .swiftCasePaths,
      .structs🤝Enums,
    ...
    trailerVideo: .init(
      bytesLength: 58_829_798,
      downloadUrl:
        "https://player.vimeo.com/external/389513997.hd.mp4?s=4a190ce5bb5574dc98361bfa06f28fb3862004f7&profile_id=175&download=1",
