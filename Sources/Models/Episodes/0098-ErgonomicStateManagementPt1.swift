...
extension Episode {
  public static let ep98_ergonomicStateManagement_pt1 = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_586_754_000),
    references: [
      // TODO
    ],
    sequence: 98,
    ...
    trailerVideo: .init(
      ...
      downloadUrl:
        "https://player.vimeo.com/external/407009519.hd.mp4?s=e40eed7d59217cb481988ec844c810b10c24db24&profile_id=175&download=1",
