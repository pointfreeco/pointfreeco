...
extension Episode {
  static let ep61_composableParsing_zip = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_560_146_400),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 43_072_387,
      downloadUrl:
        "https://player.vimeo.com/external/349951712.hd.mp4?s=62e38e7af330a0310751b8a16c2fc13d1c902cc3&profile_id=175&download=1",
