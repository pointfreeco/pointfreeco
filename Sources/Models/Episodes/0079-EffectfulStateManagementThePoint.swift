...
extension Episode {
  static let ep79_effectfulStateManagement_thePoint = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_572_847_200),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 29_754_584,
      downloadUrl:
        "https://player.vimeo.com/external/369058178.hd.mp4?s=c5ac19402690f4129805871b9b4b9823b5621b18&profile_id=175&download=1",
