...
extension Episode {
  static let ep88_theCaseForCasePaths_pt2 = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_580_104_800),
    references: [
      .structs🤝Enums,
      reference(
    ...
    trailerVideo: .init(
      bytesLength: 18_382_159,
      downloadUrl:
        "https://player.vimeo.com/external/386554253.hd.mp4?s=1cc1944394c785d14a4c8e974a3ee7e90cfdcbee&profile_id=175&download=1",
