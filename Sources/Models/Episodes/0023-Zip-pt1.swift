...
extension Episode {
  static let ep23_theManyFacesOfZip_pt1 = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_531_735_023 + 604_800),
    sequence: 23,
    title: "The Many Faces of Zip: Part 1",
    trailerVideo: .init(
      bytesLength: 41_301_707,
      downloadUrl:
        "https://player.vimeo.com/external/349879580.hd.mp4?s=94ff8588118990d5fff26c2266e760dcbfec7174&profile_id=175&download=1",
