...
extension Episode {
  static let ep89_theCaseForCasePaths_pt3 = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_580_709_600),
    references: [
      .init(
        ...
        blurb: #"""
          ...
          """#,
        link:
          "https://forums.swift.org/t/extract-payload-for-enum-cases-having-associated-value/27606",
        publishedAt: Date(timeIntervalSince1970: 1_564_935_360),
      ...
      .init(
        ...
        publishedAt: Date(timeIntervalSince1970: 1_491_667_200),
    ...
    trailerVideo: .init(
      bytesLength: 46_590_660,
      downloadUrl:
        "https://player.vimeo.com/external/387150414.hd.mp4?s=74737075ffad18263e23694682be5d6ac894ba25&profile_id=175&download=1",
      streamingSource: "https://player.vimeo.com/video/387150414"
    )
  )
}
