...
public let post0090_2022EOYSaleLastChance = BlogPost(
  author: .pointfree,
  blurb: """
    Our end-of-year sale is almost over! Subscribe to Point-Free now and get 25% off the first year!
    """,
  contentBlocks: [
  ...
  hidden: true,
  id: 90,
  publishedAt: Date(timeIntervalSince1970: 1672246800),
