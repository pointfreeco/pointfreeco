...
public let post0054_AnnouncingIsowords = BlogPost(
  author: .pointfree,
  blurb: """
...
""",
    ...
    .init(
      content: "",
      type: .image(
        src: "https://d1iqsrac68iyd8.cloudfront.net/posts/0054-announcing-isowords/isowords-screenshots.jpg",
        sizing: .fullWidth
      )
    ),
    .init(
...
**isowords** is a word search game on a vanishing cube. Connect letters on the cube to form words, the longer the better, and the third time a letter is used its cube is removed, revealing letters inside!
...
- Take it slow in "unlimited" mode, with calm and relaxing music, and no timer. Play at your own pace
- isowords looks great at day and night with dedicated light and dark themes.

### Try for free without downloading

Using iOS 14's new App Clip functionality you can play a sample game without downloading the app from the App Store. Just visit isoword's [homepage](https://www.isowords.xyz) and tap the "Play" button in the banner at the top of the screen.
...
""",
  ...
  coverImage: "https://d1iqsrac68iyd8.cloudfront.net/posts/0054-announcing-isowords/isowords-screenshots.jpg",
  id: 54,
  publishedAt: Date(timeIntervalSince1970: 1615964400),
