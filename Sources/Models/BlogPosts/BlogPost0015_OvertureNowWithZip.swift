...
public let post0015_overtureNowWithZip = BlogPost(
  author: .stephen,
  blurb: """
  ...
  contentBlocks: [
    ...
    .init(
      ...
      timestamp: nil,
      type: .image(
        src: "https://d1iqsrac68iyd8.cloudfront.net/posts/0015-overture-now-with-zip/poster.jpg")
    ),
  ...
  id: 15,
  publishedAt: .init(timeIntervalSince1970: 1_534_485_424),
