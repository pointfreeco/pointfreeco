...
public let post0019_randomZalgoGenerator = BlogPost(
  author: .brandon,
  blurb: """
  ...
  contentBlocks: [
    ...
    .init(
      ...
      timestamp: nil,
      type: .image(
        src: "https://d1iqsrac68iyd8.cloudfront.net/posts/0019-random-zalgo-generator/poster.jpg")
    ),
  ...
  id: 19,
  publishedAt: .init(timeIntervalSince1970: 1_537_424_976),
