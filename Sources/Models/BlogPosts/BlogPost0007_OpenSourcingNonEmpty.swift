...
public let post0007_openSourcingNonEmpty = BlogPost(
  author: .brandon,
  blurb: """
  ...
  contentBlocks: [
    ...
    .init(
      ...
      timestamp: nil,
      type: .image(
        src: "https://d1iqsrac68iyd8.cloudfront.net/posts/0007-open-sourcing-nonempty/poster.jpg")
    ),
    ...
    .init(
      content: """
        ...
        recent [episode](/episodes/ep20-nonempty) even showed how we could use algebra to
