...
""",
  contentBlocks: [
    .init(
      content: """
We do this only a few times a year: We’re happy to announce a [rare Point-Free sale](/discounts/cyber-monday-2021) this Cyber Monday by offering 25% off the first year of your subscription!

Once subscribed you'll get instant access to all 168 episodes (96 hours and growing!) of Point-Free content, including popular collections that have grown this past year:

### [SwiftUI Navigation](/collections/swiftui/navigation)

Navigation is a really, really complex topic, and it took us 9 episodes (near 6 hours!) of video to build up the concepts from first principles. Along the way we built a set of powerful tools that allow one to model their domains in the most concise possible way while still making it ergonomic and simple to use SwiftUI's navigation APIs. We even open sourced a [library](https://github.com/pointfreeco/swiftui-navigation) from the content of these episodes!
...
Animations are one of the most impressive features of SwiftUI, but the APIs can be quite mysterious. Our series of episodes shows how each API can be used, and builds a tool for "animating" Combine schedulers, which has amazing applications for vanilla SwiftUI and [Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) applications.

## Subscribe today!

We have plenty of exciting topics planned for 2022, including all new episodes on parsing (improving ergonomics, reversible parsing, and more, with applications to iOS routing), navigation in the [Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture), deep explorations into Swift concurrency, and more!
