...
public let post0076_WWDCSale = BlogPost(
    ...
    .init(
      content: """
        ...
        * And [more...](/)
        ...
        We hope you’ll [join us](/discounts/wwdc-2022) for all of the great material we have planned for the rest of the year!
        """,
      type: .paragraph
    )
  ],
  ...
  hidden: false,
  id: 76,
  publishedAt: Date(timeIntervalSince1970: 1654491600),
