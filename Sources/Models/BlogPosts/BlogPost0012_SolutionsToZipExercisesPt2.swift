...
public let post0012_solutionsToZipExercisesPt2 = BlogPost(
  author: .brandon,
  blurb: """
  ...
  contentBlocks: [
    .init(
      ...
      timestamp: nil,
      type: .image(
        src: "https://d1iqsrac68iyd8.cloudfront.net/posts/0012-solutions-to-zip-pt2/poster.jpg")
    ),
  ...
  id: 12,
  publishedAt: Date(timeIntervalSince1970: 1_534_312_623),
