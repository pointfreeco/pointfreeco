...
public let post0085_BlackFriday2022 = BlogPost(
  ...
  contentBlocks: [
    .init(
      content: """
        We do this only a few times a year: we're having a [rare, Point-Free
        sale][black-friday-sale] this Black Friday by offering 30% off the first year of
        your subscription!

        Once subscribed you'll get instant access to all [214 episodes][pf] (126 hours of video and
        growing!) of Point-Free content. This includes popular collections that were created or
        expanded this year, as well as all of the material we have planned for 2023!
        ...
        "sendability", streams, structured concurrency, clocks and more. Understanding all of these
        ...
        Navigation in SwiftUI is complex, but it doesn't need to be. In our [12-part
        ...
        We expanded our Composable Architecture collection of episodes by modernizing nearly
        ...
        We made significant updates to our parser library, including better error handling and
        error messaging, a new builder-style of creating parsers, and the ability to "invert"
