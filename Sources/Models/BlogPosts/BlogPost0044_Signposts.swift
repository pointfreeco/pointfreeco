...
In 2018 Apple introduced [signposts](https://developer.apple.com/documentation/os/logging/recording_performance_data) (see the WWDC video [here](https://developer.apple.com/videos/play/wwdc2018/405/)), a lightweight and effecient way to measure the performance of any part of your application. By setting up "beginning" and "ending" signposts around a task, you can get immediate aggregate stats on that task in Instruments.app, such as number of times that code path is executed, maximum and mininum duration to execute, as well as average time to execute and standard deviation.

Signposts, and more generally `os_log`, were designed to be lightweight and highly performant so that we shouldn't be afraid of dropping in dozens or hundreds of this measurements in our application. However, doing that at your whim without any regard to the code quality of your application is likely to lead to a lot of dispirate metrics cluttering your logs and application logic.
