  ...
  contentBlocks: [
    .init(
      content: ###"""
        ...
        However, even though all of the type information as been erased, `NavigationPath` has the magical ability to serialize the data to JSON, and even more magically, deserialize back into a fully-formed `NavigationPath` with data and static types intact!
