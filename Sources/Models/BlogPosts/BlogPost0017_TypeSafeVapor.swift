...
public let post0017_typeSafeVapor = BlogPost(
  ...
  contentBlocks: [
    ...
    .init(
      ...
      timestamp: nil,
      type: .image(
        src: "https://d1iqsrac68iyd8.cloudfront.net/posts/0017-type-safe-html-with-vapor/poster.jpg"
      )
    ),
    ...
    .init(
      content: """
        ...
        > Today we're open sourcing a [plugin](https://github.com/pointfreeco/swift-html-vapor) for [Vapor](http://vapor.codes)
