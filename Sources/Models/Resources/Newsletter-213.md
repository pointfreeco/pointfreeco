...
to register new dependencies with the library. It gives you the simplest way yet to register a
...
property on `DependencyValues` for you. But getting to this design took quite a bit longer than we
expected.
...
extension DependencyValues {
  @DependencyEntry(
    liveValue: LiveAPIClient(),
    previewValue: PreviewAPIClient()
  )
  var apiClient: any APIClient = TestAPIClient()
}
```
