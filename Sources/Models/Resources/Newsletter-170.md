Today we are releasing a significant update to our [SQLiteData][] library that offers a fast,
...
but SQLiteData is [usable outside of the view][observing-changes-article]: in `@Observable` 
models, UIKit view controllers, and more.

[observing-changes-article]: https://swiftpackageindex.com/pointfreeco/sqlite-data/main/documentation/sqlitedata/observing
...
error in SQLiteData, but a runtime crash in SwiftData:
...
Everything you can do with SwiftData, and more, can be done with SQLiteData. See
...
SQLiteData leverages high-performance decoding to turn fetched data into your Swift domain types,
...
The reason we have been able to make great strides in the ergonomics and performance of SQLiteData
...
And while StructuredQueries' release is tuned to SQLite and specifically its SQLiteData driver, the
...
The 0.2.0 release of SQLiteData is out _today_! Give it a spin and let us know what you think. Or,
if you have any questions or comments, join our
[discussions](https://github.com/pointfreeco/sqlite-data/discussions).
