![](https://d1iqsrac68iyd8.cloudfront.net/posts/0013-solutions-to-zip-pt3/poster.jpg)
...
> Exercise 1: In this series of episodes on `zip` we have described zipping types as a kind of way to swap the order of
...
> Exercise 1.4: `sequence: ([Parallel<A>]) -> Parallel<[A]>`
...
> Exercise 1.7: Note that all of these functions also represent the flipping of containers, e.g. an array of optionals
...
> Exercise 2: There is a function closely related to `zip` called `apply`. It has the following shape:
...
> Exercise 3: Another closely related function to `zip` is called `alt`, and it has the following shape:
