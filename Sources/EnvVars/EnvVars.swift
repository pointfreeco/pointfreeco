...
public struct EnvVars: Codable {
  ...
  public struct Cloudflare: Codable {
    ...
    private enum CodingKeys: String, CodingKey {
      ...
      case streamWebhookSecret = "CLOUDFLARE_STREAM_WEBHOOK_SECRET"
    }
  }
