...
extension Episode {
  static let ep84_testableStateManagement_ergonomics = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_575_871_200),
    references: [
      .elmHomepage,
      .reduxHomepage,
      .composableReducers,
    ...
    trailerVideo: .init(
      bytesLength: 39_298_144,
      downloadUrls: .s3(
        hd1080: "0084-trailer-1080p-f547803a6cb74d3f9faa2cc59cf4f180",
        hd720: "0084-trailer-720p-9a7bb142e01c4068a110363cb435db00",
        sd540: "0084-trailer-540p-5ef93c463fbc412d94f020155c787be4"
      ),
      id: "02790e8426849c054fcd9e96a2142a39"
    )
  )
}
