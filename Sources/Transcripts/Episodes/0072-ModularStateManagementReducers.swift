...
extension Episode {
  static let ep72_modularStateManagement_reducers = Episode(
    ...
    publishedAt: .init(timeIntervalSince1970: 1_568_008_800),
    references: [
      ...
      Episode.Reference(
        ...
        publishedAt: Date(timeIntervalSince1970: 1_544_158_800),
    ...
    trailerVideo: .init(
      bytesLength: 64_250_490,
      downloadUrls: .s3(
        hd1080: "0072-trailer-1080p-ed9333b95bc3441fa86777aa5a186ba9",
        hd720: "0072-trailer-720p-2403fac5e743466ca8097a53fb114d6a",
        sd540: "0072-trailer-540p-08887d2b2ea94ddb9eb6d3e856990ff8"
      ),
      id: "a0ca20a4070330ced4c9825462929763"
    )
  )
}
