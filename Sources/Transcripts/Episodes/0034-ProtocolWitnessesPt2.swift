...
extension Episode {
  static let ep34_protocolWitnesses_pt2 = Episode(
    ...
    publishedAt: Date(timeIntervalSince1970: 1_540_187_322),
    references: [
    ...
    trailerVideo: .init(
      bytesLength: 49_840_092,
      downloadUrls: .s3(
        hd1080: "0034-trailer-1080p-3e83b88404f94b7b882fe1fae0efb63a",
        hd720: "0034-trailer-720p-d94f638e4da2492e9cb0cf5edd754fee",
        sd540: "0034-trailer-540p-74116a442cae47b38366d080278c4a5a"
      ),
      id: "35d5be5ba2dac713a43d5cfbfc1f7a94"
    )
  )
}
