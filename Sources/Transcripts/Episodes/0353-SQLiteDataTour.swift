...
extension Episode {
  public static let ep353_sqliteDataTour = Episode(
    blurb: """
      We clean up our test suite and make use of the `expectDifference` helper, for precisely \
      describing changes to state in an exhaustive fashion. We will then rapidly add test coverage \
