...
public let post0013_solutionsToZipExercisesPt3 = BlogPost(
  author: .brandon,
  blurb: """
  ...
  contentBlocks: [
    .init(
      ...
      timestamp: nil,
      type: .image(
        src: "https://d1iqsrac68iyd8.cloudfront.net/posts/0013-solutions-to-zip-pt3/poster.jpg")
    ),
  ...
  id: 13,
  publishedAt: Date(timeIntervalSince1970: 1_534_312_623 + 86_400),
