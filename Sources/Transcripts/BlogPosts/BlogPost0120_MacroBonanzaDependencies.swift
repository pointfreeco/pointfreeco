...
extension BlogPost {
  public static let post0120_MacroBonanza = Self(
    author: .pointfree,
    blurb: """
      ...
      boilerplate code can be automatically generated for us, and the ergonomics of our \
      dependencies can be greatly improved.
      """,
    coverImage: nil,
    id: 120,
