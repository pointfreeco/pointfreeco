...
public let post0040_Collections = BlogPost(
  author: .pointfree,
  blurb: """
  ...
  contentBlocks: [
    .init(
      content: #"""
        ...
        We hope that you enjoy these improvements to the site, and we have a lot more coming. If you have any feedback for us, please feel free to [reach out](mailto:support@pointfree.co).
        """#,
      timestamp: nil,
      type: .paragraph
    )
  ...
  coverImage: nil,
  id: 40,
  publishedAt: Date(timeIntervalSince1970: 1_583_906_400),
  title: "Announcing Episode Collections"
)
