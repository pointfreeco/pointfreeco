...
public let post0032_AnOverviewOfCombine = BlogPost(
      ...
      content: #"""
        ...
        The past couple weeks we have released two completely free videos dedicated to studying the Combine framework from first principles and showing how you can incorporate it into a library or application of your own:
          ...
          - [The Combine Framework and Effects: Part 1](https://www.pointfree.co/episodes/ep80-the-combine-framework-and-effects-part-1):
            In this video, we explore Combine's core components, including the `Publisher` and `Subscriber` protocols. We also cover some convenience functions and operators, which are layered over these more basic units.

          - [The Combine Framework and Effects: Part 2](https://www.pointfree.co/episodes/ep81-the-combine-framework-and-effects-part-2):
            In this video we show how the Combine framework can be used to describe side effects in a reducer-based architecture, like [Redux](https://redux.js.org). We take an existing library we've been experimenting with and use Combine to help solve a critical problem.
  ...
  coverImage: "https://i.vimeocdn.com/video/829976257.jpg",
  id: 32,
  publishedAt: Date(timeIntervalSince1970: 1_574_229_600),
