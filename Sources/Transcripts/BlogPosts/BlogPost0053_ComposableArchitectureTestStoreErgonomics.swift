...
public let post0053_composableArchitectureTestStoreErgonomics = BlogPost(
  ...
  contentBlocks: [
    ...
    .init(
      ...
      type: .image(
        src:
          "https://user-images.githubusercontent.com/658/110347127-4de1da80-7ffe-11eb-846e-5bd9e4c16beb.png"
      )
    ),
    .init(
      content: #"""
    ...
    .init(
      ...
      type: .image(
        src:
          "https://user-images.githubusercontent.com/658/110347138-51756180-7ffe-11eb-9dbd-b6f8915a475f.png"
      )
    ),
    .init(
      content: #"""
