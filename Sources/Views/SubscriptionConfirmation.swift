...
public struct DiscountCountry {
  ...
  public static let all: [DiscountCountry] = [
    ...
    .init(countryCode: "XK", name: "Kosovo"),
    .init(countryCode: "KG", name: "Kyrgyzstan"),
    ...
    .init(countryCode: "TJ", name: "Tajikistan"),
    .init(countryCode: "TG", name: "Togo"),
    .init(countryCode: "TR", name: "Turkey"),
    .init(countryCode: "TM", name: "Turkmenistan"),
    ...
    .init(countryCode: "UZ", name: "Uzbekistan"),
