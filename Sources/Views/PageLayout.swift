...
Prism.languages.swift = Prism.languages.extend('clike', {
  ...
  'keyword': /\b(?:actor|Any|as|associativity|associatedtype|async|await|break|case|catch|class|continue|convenience|default|defer|deinit|didSet|do|dynamic(?:Type)?|else|enum|extension|fallthrough|false|fileprivate|final|for|func|get|guard|if|import|in|indirect|infix|init|inout|internal|is|lazy|left|let|mutating|new|nil|none|nonisolated|nonmutating|open|operator|optional|override|postfix|precedence|precedencegroup|prefix|private|protocol|Protocol|public|repeat|required|rethrows|return|right|safe|self|Self|set|some|static|struct|subscript|super|switch|throws?|true|try|Type|typealias|unowned|unsafe|var|weak|where|while|willSet|_(?:modify|read)?|__(?:COLUMN__|FILE__|FUNCTION__|LINE__)|#(?:available|colorLiteral|column|dsohandle|elseif|else|endif|error|fileID|fileLiteral|filePath|file|function|if|imageLiteral|keyPath|line|selector|sourceLocation|warning))\b/,
  'number': /\b(?:[\d_]+(?:\.[\de_]+)?|0x[a-f0-9_]+(?:\.[a-f0-9p_]+)?|0b[01_]+|0o[0-7_]+)\b/i,
  'constant': /\b(?:nil|[A-Z_]{2,}|k[A-Z][A-Za-z_]+)\b/,
  'atrule': /@\b(?:available|auto_closure|autoclosure|class_protocol|convention|discardableResult|dynamicCallable|dynamicMemberLookup|escaping|exported|frozen|GKInspectable|IB(?:Outlet|Designable|Action|Inspectable)|inlinable|inline|main|noreturn|NS(?:ApplicationMain|Copying|Managed)|objc|objcMembers|propertyWrapper|requires_stored_property_inits|resultBuilder|rethrows|testable|UIApplicationMain|unknown|usableFromInline|warn_unqualified_access|_(?:disfavoredOverload|exported))\b/,
