...
private let openSourceSection = View<Prelude.Unit> { _ in
  [
    h1(
      [`class`([Class.pf.type.responsiveTitle4, Class.padding([.mobile: [.top: 3]])])],
      "Open source"
    ),
    p(
      [`class`([Class.pf.type.body.regular, Class.padding([.mobile: [.bottom: 2]])])],
    ...
    p(
      ...
      a(
        [href(gitHubUrl(to: .organization)), `class`([Class.pf.colors.link.purple])],
