...
private func adminIndexView(currentUser: User) -> Node {
  return .ul(
    ...
    .li(
      .a(
        attributes: [.href(path(to: .admin(.freeEpisodeEmail(.index))))], "Send free episode email")
    ),
    .li(
      .a(
        attributes: [.href(path(to: .admin(.newBlogPostEmail(.index))))], "Send new blog post email"
      )),
