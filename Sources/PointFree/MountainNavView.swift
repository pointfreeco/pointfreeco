...
func mountainNavView(mountainsStyle: NavStyle.MountainsStyle, currentUser: User?, subscriberState: SubscriberState, currentRoute: Route?) -> [Node] {
  ...
  return menuAndLogoHeaderView(mountainsStyle: mountainsStyle, currentUser: currentUser, subscriberState: subscriberState, currentRoute: currentRoute)
  + [
...
private func menuAndLogoHeaderView(mountainsStyle: NavStyle.MountainsStyle, currentUser: User?, subscriberState: SubscriberState, currentRoute: Route?) -> [Node] {
        ...
        gridRow([
          ...
          gridColumn(sizes: [.mobile: 12, .desktop: 6], [
            div(
              ...
              headerLinks(mountainsStyle: mountainsStyle, currentUser: currentUser, subscriberState: subscriberState, currentRoute: currentRoute)
            )
            ])
          ]),
...
private func headerLinks(mountainsStyle: NavStyle.MountainsStyle, currentUser: User?, subscriberState: SubscriberState, currentRoute: Route?) -> [Node] {
