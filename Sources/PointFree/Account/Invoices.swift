  ...
  return gridRow(
    gridColumn(
      ...
      div(
        ...
        gridRow(
          [`class`([Class.padding([.mobile: [.topBottom: 3]])])],
          gridColumn(
            sizes: [.mobile: 12, .desktop: 6], [],
            gridRow(
              gridColumn(
                sizes: [.mobile: 12, .desktop: 2], [`class`([Class.type.bold])],
                div("Bill to")
              ),
              gridColumn(
                sizes: [.mobile: 12, .desktop: 10],
                [`class`([Class.padding([.mobile: [.bottom: 1]])])],
          ...
          gridColumn(
            ...
            gridRow(
              gridColumn(
                sizes: [.mobile: 12, .desktop: 6], [`class`([Class.type.bold])],
                div("Invoice number")
              ),
              gridColumn(
                sizes: [.mobile: 12, .desktop: 6], [`class`([Class.padding([.mobile: [.bottom: 1]])])],
                div(.text(invoice.number.rawValue))
              )
            ),
            gridRow(
        ...
        gridRow(
          [`class`([Class.padding([.mobile: [.bottom: 2]]), Class.type.bold])],
          gridColumn(
            sizes: [.mobile: 4, .desktop: 6], [],
            div("Description")
          ),
          gridColumn(
            sizes: [.mobile: 4, .desktop: 2], [`class`([Class.type.align.end])],
            div("Quantity")
          ),
          gridColumn(
            sizes: [.mobile: 0, .desktop: 2], [`class`([Class.type.align.end, Class.hide(.mobile)])],
            div("Unit price")
          ),
          gridColumn(
            sizes: [.mobile: 4, .desktop: 2], [`class`([Class.type.align.end])],
        ...
        .fragment(
          invoice.lines.data.map { item in
            gridRow(
              ...
              gridColumn(
                sizes: [.mobile: 2, .desktop: 2], [`class`([Class.type.align.end])],
                div(.text("\(item.quantity)"))
              ),
              gridColumn(
                sizes: [.mobile: 0], [`class`([Class.type.align.end, Class.hide(.mobile)])],
        ...
        gridRow(
          ...
          gridColumn(sizes: [.mobile: 2, .desktop: 8], [], []),
          gridColumn(
            sizes: [.mobile: 6, .desktop: 2], [`class`([Class.type.align.end])],
            div("Subtotal")
          ),
          gridColumn(
            sizes: [.mobile: 4, .desktop: 2], [`class`([Class.type.align.end])],
        ...
        gridRow(
          [`class`([Class.padding([.mobile: [.topBottom: 2]]), Class.type.bold])],
          gridColumn(sizes: [.mobile: 2, .desktop: 8], [], []),
          gridColumn(
            sizes: [.mobile: 6, .desktop: 2], [`class`([Class.type.align.end])],
            div("Amount due")
