      ...
      .td(
        ...
        .div(
          ...
          .p(
            ...
            """
            Someone just subscribed with your referral code, which means you get one month of Point-Free for free! We've applied a credit of $18 to your account, which you should see reflected on \(.a(attributes: [.href(url(to: .account(.index)))], "your account page")).
            """
          ),
          .p(
