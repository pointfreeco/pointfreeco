...
private let roundedStyles =
  ...
  <> Class.border.rounded.left
  % borderRadius(topLeft: .px(cornerRadius), bottomLeft: .px(cornerRadius))
  <> Class.border.rounded.right
  % borderRadius(topRight: .px(cornerRadius), bottomRight: .px(cornerRadius))
