...
public struct Client {
  ...
  public var fetchNewSubscribersToWelcome: () -> EitherIO<Error, [Models.User]>
  ...
  public init(
    ...
    fetchNewSubscribersToWelcome: @escaping () -> EitherIO<Error, [Models.User]>,
    ...
    self.fetchNewSubscribersToWelcome = fetchNewSubscribersToWelcome
